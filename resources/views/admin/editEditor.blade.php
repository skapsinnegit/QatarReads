    ...
    <div class="content container">
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                ...
                <form action="{{ route("admin.editEditor",['id'=>encrypt($editor->id)]) }}" class="form-horizontal" method="post" novalidate>
                    {{ csrf_field() }}
                    <div class="panel panel-flat">
                        <div class="panel-heading">
                            <h5 class="panel-title">Update editor</h5>
                        </div>
                        ...
                        <div class="panel-body">
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control" name="first_name" value="{{ old("first_name",$editor->first_name) }}" placeholder="First Name" required>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control" name="last_name" value="{{ old("last_name",$editor->last_name) }}" placeholder="Last Name" required>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input type="email" class="form-control" name="email"  placeholder="Email" value="{{ old("email",$editor->email) }}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control" name="mobile"  placeholder="Phone" value="{{ old("mobile",$editor->mobile) }}" required>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <select class="select select2" name="editor_roll" id="editor_roll">
                                         ...
                                         <option value="1" {{old('editor_roll',$editor->editor_roll) == 1 ? "selected" : ""}}>Add / Manage</option>
                                         <option value="2" {{old('editor_roll',$editor->editor_roll) == 2 ? "selected" : ""}}>Manage</option>
                                    </select>
                                ...
                                <div class="col-md-9">
                                    <select id="assignpgm" class="select select2 js-example-basic-multiple" name="assigned_program[]" multiple="multiple">
                                        @foreach($programs as $program)
                                         <option value="{{$program->id}}" {{in_array($program->id, $editor->assigned_program) ? "selected" : ""}}>{{$program->name}}</option>
                                        @endforeach
                                    </select>
                                    <p class="feedback">@if($errors->has('assigned_progragm')) {{ $errors->first('assigned_progragm') }} @endif</p>
                                </div>
                            </div>
